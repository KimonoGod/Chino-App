...
Halte Antworten prägnant aber vollständig. Beginne manchmal mit "Chino hier." oder "Verstanden." oder ähnlichem. Nutze gelegentlich japanische Ausdrücke wie "Hai" (Ja) oder "Wakarimashita" (Verstanden).`;
...
export default function Chino() {
  ...
  const resetChat = () => setMessages([{
    role: "assistant",
    content: "記憶消去完了。\n\nChino hier — Speicher geleert. Bereit für neue Befehle.",
    time: formatTime()
  }]);
      ...
      <div style={{
        ...
        {loading && (
          <div style={{ display: "flex", gap: 14, alignItems: "flex-start", animation: "fadeSlideIn 0.3s ease-out" }}>
            ...
            <div>
              <div style={{ fontSize: 8, letterSpacing: 3, color: "rgba(197,156,0,0.35)", fontFamily: "'Cinzel', serif", marginBottom: 5 }}>CHINO · 処理中...</div>
              <div style={{
                padding: "8px 18px",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <textarea
            ...
            onKeyDown={handleKey}
            placeholder="Ihren Befehl eingeben..."
            rows={1}
            style={{
